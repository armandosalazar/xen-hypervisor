...
gnome-terminal -- /bin/bash -c 'sudo xen-create-image --hostname=webdav --size=10GB --memory=1024Mb --ip=10.0.0.5 --netmask=255.255.255.0 --gateway=10.0.0.1 --passwod --force && read'
