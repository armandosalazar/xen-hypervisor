...
iptables -A PREROUTING -t nat -i wlp3s0 -p tcp --dport 443 -j DNAT --to-destination 10.0.0.3:443
iptables -A PREROUTING -t nat -i wlp3s0 -p tcp --dport 8000 -j DNAT --to-destination 10.0.0.5:443
...
iptables -A FORWARD -p tcp -d 10.0.0.5 --dport 443 -j ACCEPT
